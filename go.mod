module github.com/cmd-stream/stress-test-go

go 1.24.1

require (
	github.com/cmd-stream/cmd-stream-go v0.7.3
	github.com/cmd-stream/codec-json-go v0.0.0-20260507023604-bd9f383b4b33
	github.com/ymz-ncnk/circbrk-go v0.0.0-20260117185435-2da55ad9387e
	gopkg.in/yaml.v3 v3.0.1
)

require (
	github.com/cmd-stream/codec-go v0.0.0-20260507023155-19643e99e7ab // indirect
	github.com/mus-format/common-go v0.0.0-20260324174526-3d8f1741b5a2 // indirect
	github.com/mus-format/mus-stream-go v0.10.2 // indirect
